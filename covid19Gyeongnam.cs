    ...
    class covid19Gyeongnam
    {
        ...
        public void covid19()
        {
            try
            {
                ...
                _driver.Navigate().GoToUrl("http://xn--19-q81ii1knc140d892b.kr/main/main.do");

                _driver.Manage().Timeouts().ImplicitWait = TimeSpan.FromSeconds(10);

                Console.WriteLine("시작");
                IList<IWebElement> e1 = _driver.FindElement(By.Id("patients")).FindElement(By.TagName("tbody")).FindElements(By.Id("patient4"));

                int cnt = e1.Count;

                for (int i = 0; i < cnt; i++)
                {
                    covid19_Gyeongnam model = new covid19_Gyeongnam();
                    ...
                    sb.Append(" insert into covid19_Gyeongnam values(");
